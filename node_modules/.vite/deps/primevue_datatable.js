...
var _hoisted_14 = ["aria-label", "disabled", "data-p-severity"];
function render5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16, _hoisted_14)), [[_directive_ripple]]);
}
...
var _hoisted_17 = ["value", "aria-invalid"];
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $options.getPTOptions("root")), null, 16, _hoisted_17);
}
...
var _hoisted_111 = ["aria-label", "aria-current", "onClick", "data-p-highlight"];
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    }), [createTextVNode(toDisplayString(pageLink), 1)], 16, _hoisted_111)), [[_directive_ripple]]);
  }), 128))], 16);
}
...
var script22 = {
  ...
  methods: {
    ...
    hasBreakpoints: function hasBreakpoints() {
      return _typeof4(this.template) === "object";
    },
      ...
      if (!this.disabled && !this.readonly) {
        ...
        if (this.binary) {
          ...
          if (this.checked)
            ...
            newModelValue = this.modelValue ? [].concat(_toConsumableArray3(this.modelValue), [this.value]) : [this.value];
        }
...
var _hoisted_115 = ["data-p-highlight", "data-p-disabled"];
var _hoisted_212 = ["id", "value", "name", "checked", "tabindex", "disabled", "readonly", "required", "aria-labelledby", "aria-label", "aria-invalid"];
...
var _hoisted_116 = ["data-p-highlight", "data-p-disabled"];
var _hoisted_213 = ["id", "value", "name", "checked", "tabindex", "disabled", "readonly", "aria-labelledby", "aria-label", "aria-invalid"];
function render18(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $options.getPTOptions("input")), null, 16, _hoisted_213), createBaseVNode("div", mergeProps({
    "class": _ctx.cx("box")
  }, $options.getPTOptions("box")), [createBaseVNode("div", mergeProps({
    "class": _ctx.cx("icon")
  }, $options.getPTOptions("icon")), null, 16)], 16)], 16, _hoisted_116);
}
...
var _hoisted_5 = [_hoisted_121, _hoisted_218, _hoisted_3, _hoisted_4];
...
var _hoisted_221 = ["id", "aria-modal"];
      ...
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            filterModel: $props.filters[$props.field],
            filterCallback: $options.filterCallback
          }, null, 8, ["field", "filterModel", "filterCallback"]))], 16, _hoisted_221)), [[_directive_focustrap]]) : createCommentVNode("", true)];
        }),
        _: 1
...
var _hoisted_124 = ["tabindex", "colspan", "rowspan", "aria-sort", "data-p-sortable-column", "data-p-resizable-column", "data-p-highlight", "data-p-filter-column", "data-p-frozen-column", "data-p-reorderable-column"];
...
var script35 = {
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data13 = _toConsumableArray4(value);
      ...
      for (var i = 0; i < data13.length; i++) {
            ...
            if (filterMeta.operator) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                  ...
                  localMatch = this.executeLocalFilter(filterField, data13[i], filterConstraint);
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](ObjectUtils.resolveFieldData(data13[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
    ...
    onSpaceKey: function onSpaceKey(event2, rowData, rowIndex2, slotProps) {
      ...
      if (event2.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = ObjectUtils.findIndexInList(this.selection[0], data13);
          lastSelectedRowIndex = ObjectUtils.findIndexInList(this.selection[this.selection.length - 1], data13);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = ObjectUtils.findIndexInList(this.selection, data13);
        }
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            this.d_selectionKeys[String(ObjectUtils.resolveFieldData(data13, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this.d_editingRowKeys[String(ObjectUtils.resolveFieldData(data13, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    exportCSV: function exportCSV(options, data13) {
      var _this6 = this;
      var csv = "\uFEFF";
      if (!data13) {
        data13 = this.processedData;
        if (options && options.selectionOnly)
          data13 = this.selection || [];
        else if (this.frozenValue)
          data13 = data13 ? [].concat(_toConsumableArray4(this.frozenValue), _toConsumableArray4(data13)) : this.frozenValue;
      }
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event2 = e.originalEvent;
      var data13 = e.data;
      var groupFieldValue = ObjectUtils.resolveFieldData(data13, this.groupRowsBy);
    ...
    processedData: function processedData() {
      ...
      if (!this.lazy && !((_this$virtualScroller = this.virtualScrollerOptions) !== null && _this$virtualScroller !== void 0 && _this$virtualScroller.lazy)) {
        if (data13 && data13.length) {
          ...
          if (this.sorted) {
            if (this.sortMode === "single")
              data13 = this.sortSingle(data13);
            else if (this.sortMode === "multiple")
              data13 = this.sortMultiple(data13);
          }
        }
      }
      return data13;
