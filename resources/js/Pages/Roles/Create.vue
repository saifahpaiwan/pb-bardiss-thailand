...
const ObjSubtitle = ref([
    ...
    { message: 'เพิ่มข้อมูลสิทธิ์ผู้ใช้งาน' },
]);
                    ...
                    <div class="card-body">
                        <div class="row mb-1">
                            <div class="col-md-6 responsive-mobile-title ">
                                <h4 class="header-title"> เพิ่มข้อมูลสิทธิ์ผู้ใช้งาน (Roles) </h4>
                        ...
                        <form @submit.prevent="submit" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" v-for="permission in permissionArr" :key="permission.id">
                                            <div class="box-title-roles"> {{ permission.name }} </div>
                                            <div class="box-content-roles">
                                                <div class="custom-control custom-checkbox" v-for="permissionRoles in permission.list" :key="permissionRoles.id">
