                    ...
                    <div class="card-body">
                        <div class="row mb-1">
                            <div class="col-md-6 responsive-mobile-title ">
                                <h4 class="header-title"> เพิ่มข้อมูลผู้ใช้งาน (Users) </h4>
                        ...
                        <form @submit.prevent="submit" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <InputLabel for="password" value="รหัสผ่าน (Password) : " required />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <InputLabel for="confirm-password"
                                            value="ยืนยันรหัสผ่าน (Confirm confirm-password) : " required />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <InputLabel for="roles" value="สิทธิ์ผู้ใช้งาน : " />
